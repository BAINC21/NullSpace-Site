  ...
  return (
    <div className="fade-in">
      ...
      {(() => {
        ...
        return (activeMedia.length > 0 || isLoggedIn) ? (
...
// ─── ADMIN PAGE ───
function AdminPage({ projects, setProjects, analytics, isLoggedIn, onLogin, inboxMessages, onClearInbox, credentials, onUpdateCredentials, onSaveProject, onDeleteProject, onRestoreProject, onPermanentDeleteProject, connStatus, activityLog }) {
    ...
    <div className="admin-page fade-in">
      ...
      {adminTab === "inbox" && (
        <div className="admin-table-wrap">
          <div className="admin-table-header">
            <h3>Visitor Messages ({inboxMessages.length})</h3>
          ...
          {inboxMessages.length === 0 ? (
            ...
            inboxMessages.map((m) => (
              <div key={m.id} className="admin-project-row" style={{ flexDirection: "column", alignItems: "flex-start", gap: 8 }}>
      ...
      try {
        if (isSupabaseConfigured()) {
          ...
          if (connTest.ok) {
            ...
            const [p, m, msgs, creds, stats, log] = await Promise.all([
              db.loadProjects(),
              db.loadMedia(),
              db.loadMessages(),
              db.loadSettings(),
            ...
            db.trackVisit();
            // Purge items deleted 30+ days ago
            db.purgeOldDeleted();
          } else {
