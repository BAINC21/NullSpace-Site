  ...
  return (
    <div className="admin-page fade-in">
      <div className="admin-header">
        ...
        <div style={{ display: "flex", gap: 8 }}>
          <button className={`btn-ghost ${adminTab === "overview" ? "" : ""}`} onClick={() => setAdminTab("overview")} style={adminTab === "overview" ? { borderColor: "var(--green)", color: "var(--green)" } : {}}>
